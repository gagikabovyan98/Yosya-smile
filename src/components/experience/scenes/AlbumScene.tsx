...
const portraitSpreads: Spread[] = [
  {
    eyebrow: "ПОРТРЕТ I · КРАСОТА",
    title: "Ты красивая. Вот прям очень.",
    text: "И каждый раз, когда я смотрю на тебя, все красивые слова почему-то становятся слишком обычными. Мне нравятся твои глаза, волосы, выражение лица и даже то, как ты просто сидишь и думаешь о чём-то своём. Ты всегда остаёшься самой красивой частью моего дня.",
    note: "Я могу смотреть на тебя долго. И мне всё равно будет мало.",
    images: [{ ...photos[0], frame: "ovalVictorian" }],
  },
  {
    eyebrow: "ПОРТРЕТ II · ВЗГЛЯД",
    title: "Мне нравится смотреть на тебя. Очень.",
    text: "Когда ты улыбаешься, чем-то увлечена, немного сонная или просто находишься рядом. В каждом твоём состоянии есть что-то красивое и настоящее. Мне хочется замечать все эти моменты и запоминать тебя именно такой.",
    note: "Кажется, я снова засмотрелся.",
    images: [{ ...photos[1], frame: "brass" }],
  },
  {
    eyebrow: "ПОРТРЕТ III · РЯДОМ",
    title: "Мне нравится, какая ты рядом.",
    text: "С тобой можно смеяться с какой-нибудь ерунды, долго молчать, говорить о странных вещах и просто ничего не делать. И всё это всё равно ощущается особенным. Ты умеешь превращать обычный момент в тот, который потом хочется вспоминать.",
    note: "С тобой хорошо даже без особого повода.",
    images: [{ ...photos[2], frame: "silver" }],
  },
  {
    eyebrow: "ПОРТРЕТ IV · ТИШИНА",
    title: "Даже когда ты молчишь, мне хорошо с тобой.",
    text: "Мне нравится просто находиться рядом с тобой. Смотреть, как ты чем-то занята, слушать твой голос или сидеть вместе в тишине. В такие моменты мне никуда не хочется торопиться.",
    note: "Рядом с тобой всё становится немного уютнее.",
...
const artSpreads: Spread[] = [
  {
    eyebrow: "РИСУНОК I · ТВОЙ СТИЛЬ",
    title: "Я каждый раз немного залипаю на твои рисунки.",
    text: "Не знаю, как ты это делаешь. На обычном листе у тебя появляются люди, на которых хочется смотреть и думать, кто они такие и что у них случилось. Я могу просто сидеть и долго разглядывать всё, что ты нарисовала.",
    note: "Короче, мне очень нравится. И я тобой горжусь.",
    images: [{ ...works.characterI, frame: "carvedWood" }, { ...works.paperB, frame: "paperOnly" }],
  },
  {
    eyebrow: "РИСУНОК II · НАСТРОЕНИЕ",
    title: "У них правда есть настроение.",
    text: "Иногда смотришь на лицо и сразу чувствуешь, что у этого человека в голове происходит что-то своё. Кто-то выглядит спокойным, кто-то грустным, кто-то вообще подозрительным. Мне нравится, что они у тебя все разные.",
    note: "Будто сейчас кто-то из них возьмёт и заговорит.",
    images: [{ ...works.sheetsG, frame: "silver" }, { ...works.detailD, frame: "broken" }],
  },
  {
    eyebrow: "РИСУНОК III · ДЕТАЛИ",
    title: "Мне нравятся все эти маленькие детали.",
    text: "Как ты рисуешь волосы, глаза, руки, одежду и всякие мелочи, которые я сначала могу даже не заметить. А потом смотрю ещё раз и нахожу что-то новое. В такие моменты особенно видно, сколько внимания ты вложила в рисунок.",
    note: "В каждом из них правда чувствуется часть тебя.",
    images: [{ ...works.traceH, frame: "gothicArch" }, { ...works.framedC, frame: "brass" }],
  },
  {
    eyebrow: "РИСУНОК IV · ДАЛЬШЕ",
    title: "Пожалуйста, рисуй ещё.",
    text: "Я хочу видеть твои новые идеи, новых героев и всё странное, красивое и милое, что ещё появится у тебя в голове. Мне очень нравится наблюдать за тем, что ты создаёшь. И я правда хочу увидеть намного больше.",
    note: "Для твоих работ у меня всегда найдётся ещё одна рама.",
